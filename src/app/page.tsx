    ...
    <div className='mx-auto flex max-w-(--breakpoint-sm) flex-col gap-12 place-self-center px-4 py-20 md:px-0'>
      <div className='flex flex-col gap-2'>
        ...
        <Prose>
          ...
          <p>
            Originally from Queens, NY, I studied CS at UB and now live in the
            Bay Area. Outside of work, I&apos;m probably watching Twitch, gaming
            with friends, or tweaking my mechanical keyboards.
          </p>
        </Prose>
      </div>
