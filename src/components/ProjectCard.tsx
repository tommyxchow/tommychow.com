...
export default function ProjectCard({
  ...
  return (
    <a aria-labelledby={name} href={url} target='_blank'>
      <article className='-mx-4 flex flex-col gap-4 p-4 transition-[background] hover:bg-zinc-100 hover:dark:bg-zinc-900 sm:flex-row sm:items-center sm:rounded-lg'>
