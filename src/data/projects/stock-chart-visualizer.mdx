...
Stock Char Visualizer was a final project completed during [CSE 115](https://catalog.buffalo.edu/courses/?abbr=CSE&num=115), my first computer science course at [UB](https://www.buffalo.edu/). In CSE 115, we were assigned to complete a web app that utilized at least one public API and library.
